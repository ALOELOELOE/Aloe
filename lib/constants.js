...
export const PROGRAM_ID = "aloe_auction_v4.aleo";
export const PROGRAM_V4_ID = "aloe_auction_v4.aleo"; // v4: record-free reveal & refund
...
// Block timing (approximate — Aleo testnet produces blocks every ~3 seconds)
...
export const DEFAULT_COMMIT_DURATION = 1200; // ~1 hour (1200 blocks × 3s)
export const DEFAULT_REVEAL_DURATION = 600; // ~30 minutes (600 blocks × 3s)
